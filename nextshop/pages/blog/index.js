      ...
      <div>
        <main>
          <section
            ...
            style={{ backgroundImage: 'url(/static/images/heading-pages-05.jpg)' }}
          >
                ...
                <div className="col-md-8 col-lg-9 p-b-75">
                  ...
                  <span className="m-l-3 m-r-6">|</span>
                        ...
                        <a href="blog-detail.html" className="s-text20">
                          Continue Reading
                          <FontAwesomeIcon icon={faLongArrowAltRight} className="m-l-8" aria-hidden="true" />
                        </a>
                      </div>
                    </div>
                    {/* item blog */}
                    <div className="item-blog p-b-80">
                      <a href="blog-detail.html" className="item-blog-img pos-relative dis-block hov-img-zoom">
                        <img src="/static/images/blog-05.jpg" alt="IMG-BLOG" />
                        <span className="item-blog-date dis-block flex-c-m pos1 size17 bg4 s-text1">
                          26 Dec, 2018
                        </span>
                      </a>
                    ...
                    <div className="item-blog p-b-80">
                      <a href="blog-detail.html" className="item-blog-img pos-relative dis-block hov-img-zoom">
                        <img src="/static/images/blog-03.jpg" alt="IMG-BLOG" />
                        <span className="item-blog-date dis-block flex-c-m pos1 size17 bg4 s-text1">
                          16 Dec, 2018
                        </span>
                      </a>
                    ...
                    <ul className="bgwhite">
                      <li className="flex-w p-b-20">
                        <a href="product-detail.html" className="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
                          <img src="/static/images/item-16.jpg" alt="IMG-PRODUCT" />
                        </a>
                      ...
                      <li className="flex-w p-b-20">
                        <a href="product-detail.html" className="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
                          <img src="/static/images/item-17.jpg" alt="IMG-PRODUCT" />
                        </a>
                        <div className="w-size23 p-t-5">
                          <a href="product-detail.html" className="s-text20">
